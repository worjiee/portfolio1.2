    ...
    <section className="w-full px-[18px] py-16 md:ml-[36%] md:w-[64%] md:px-[5vw] md:py-[8vw] lg:ml-[34%] lg:w-[66%] lg:px-[6vw]">
      <section id="work">
        <MotionReveal className="mb-12 flex items-end justify-between">
          ...
          <p className="hidden font-[family-name:var(--font-mono)] text-[0.68rem] font-medium tracking-[.08em] text-[var(--subtle)] sm:block">01 — 04 / 2025–26</p>
        </MotionReveal>
      ...
      <section id="about"><MotionReveal className="my-24 grid grid-cols-1 gap-8 border-y border-[var(--border)] py-16 lg:grid-cols-[.55fr_1.4fr_.7fr]">
          ...
          <div className="flex flex-wrap gap-4 border-[var(--border)] font-[family-name:var(--font-mono)] text-[0.65rem] font-medium text-[var(--subtle)] uppercase lg:flex-col lg:border-l lg:pl-6"><span>01 Front-end</span><span>02 Back-end</span><span>03 Databases</span></div>
