...
export function ProfileSidebar() {
  return <aside aria-label="Profile" className="relative flex min-h-svh w-full items-center border-b border-[var(--border)] bg-[var(--sidebar)] px-5 py-16 md:fixed md:inset-y-0 md:left-0 md:w-[36%] md:overflow-y-auto md:border-r md:border-b-0 md:px-8 lg:w-[34%]">
    <div className="mx-auto flex w-full max-w-[420px] flex-col md:my-auto">
      <Image src="/images/profile.svg" alt="Karl profile placeholder" width={150} height={150} priority className="mb-10 size-[120px] self-center rounded-full object-cover ring-[3px] ring-[var(--surface)] outline outline-1 outline-[var(--border)] shadow-[0_14px_32px_rgba(17,26,43,.12)] md:size-[142px]" />
      ...
      <p className="mb-6 max-w-md text-[0.98rem] leading-[1.82] text-[var(--muted)]">I’m an IT student and developer who enjoys building web applications, systems, and clean digital experiences. I’m exploring full-stack development, databases, and UI/UX while turning ideas into working projects.</p>
